...
const isAdminRoute = () => {
  ...
  const hasCompanyAliasAdminRoute = /^\/[^\/]+\/(recordatorios|empleados|inicio|fichajes|horas|vacaciones|documentos|mensajes|cuadrante|configuracion|usuario)/.test(path);
