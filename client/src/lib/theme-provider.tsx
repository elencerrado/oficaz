...
const isAdminRoute = () => {
  ...
  const hasCompanyAliasAdminRoute = /^\/[^\/]+\/(recordatorios|empleados|inicio|fichajes|misfichajes|horas|vacaciones|documentos|mensajes|cuadrante|configuracion|usuario)/.test(path);
