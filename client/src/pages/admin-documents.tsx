                  ...
                  <div className="space-y-3">
                    {filteredDocuments.map((document: Document) => {
                      ...
                      return (
                        <div
                          key={document.id}
                          className="flex flex-col sm:flex-row p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow gap-3"
                        >
