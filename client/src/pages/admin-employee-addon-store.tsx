...
export default function AddonStore() {
  ...
  const addonsWithStatus: AddonWithStatus[] = (addons || []).map(addon => {
    ...
    // isPurchased should ONLY be true if status is 'active' (not pending_cancel)
    // pending_cancel means cancellation is scheduled - don't show as "purchased" in store
    const isActive = companyAddon?.status === 'active';
                      ...
                      <CardHeader className="pb-2">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <div className="flex items-center gap-2 flex-1">
                            ...
                            {['ai_assistant', 'inventory', 'crm', 'accounting'].includes(addon.key) && (
