...
export default function WorkReportsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-employee-gradient text-gray-900 dark:text-white flex flex-col page-scroll">
      ...
      {reportsLoading ? (
        <ListLoadingState message="partes de trabajo" />
      ) : reports.length === 0 ? (
        <ListEmptyState 
          title="Sin partes de trabajo" 
          subtitle="Crea tu primer parte de trabajo para empezar a registrar tus visitas" 
        />
      ) : (
        ...
        <DialogContent className="fixed inset-0 w-screen h-screen max-w-none max-h-none translate-x-0 translate-y-0 top-0 left-0 p-0 rounded-none bg-white dark:bg-gray-900 flex flex-col border-0">
          ...
          <div className="flex-1 flex flex-col p-6 gap-6 overflow-auto">
            ...
            <div className="flex-1 flex flex-col min-h-0">
              ...
              <div
                className="flex-1 min-h-[240px] bg-white dark:bg-gray-800 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-2xl shadow-inner relative"
              ...
              <div className="flex justify-between items-center mt-4 gap-3">
                <Button variant="outline" size="sm" onClick={clearClientCanvas}>
                  Borrar
                </Button>
                <div className="text-xs text-gray-500 dark:text-gray-400">
                  La firma se adjuntará al parte.
                </div>
              </div>
            </div>
          </div>
