        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 opacity-3">
            ...
            <div className="grid grid-cols-6 xl:grid-cols-8 gap-8 xl:gap-12 p-4 xl:p-8 w-full h-full" style={{
              ...
              {/* Row 2 */}
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-indigo-400/40 via-indigo-500/50 to-indigo-700/60 rounded-2xl backdrop-blur-xl border border-indigo-200/30 flex items-center justify-center shadow-lg shadow-indigo-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '4s', animationDuration: '7.6s'}}>
                <Smartphone className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-teal-400/40 via-teal-500/50 to-teal-700/60 rounded-2xl backdrop-blur-xl border border-teal-200/30 flex items-center justify-center shadow-lg shadow-teal-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '4.5s', animationDuration: '7.8s'}}>
                <Globe className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-rose-400/40 via-rose-500/50 to-rose-700/60 rounded-2xl backdrop-blur-xl border border-rose-200/30 flex items-center justify-center shadow-lg shadow-rose-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '5s', animationDuration: '8s'}}>
                <CheckCircle className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-emerald-400/40 via-emerald-500/50 to-emerald-700/60 rounded-2xl backdrop-blur-xl border border-emerald-200/30 flex items-center justify-center shadow-lg shadow-emerald-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '5.5s', animationDuration: '8.2s'}}>
                <Star className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-violet-400/40 via-violet-500/50 to-violet-700/60 rounded-2xl backdrop-blur-xl border border-violet-200/30 flex items-center justify-center shadow-lg shadow-violet-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '6s', animationDuration: '8.4s'}}>
                <Clock className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-amber-400/40 via-amber-500/50 to-amber-700/60 rounded-2xl backdrop-blur-xl border border-amber-200/30 flex items-center justify-center shadow-lg shadow-amber-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '6.5s', animationDuration: '8.6s'}}>
                <Users className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-lime-400/40 via-lime-500/50 to-lime-700/60 rounded-2xl backdrop-blur-xl border border-lime-200/30 flex items-center justify-center shadow-lg shadow-lime-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '7s', animationDuration: '8.8s'}}>
                <FileText className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-sky-400/40 via-sky-500/50 to-sky-700/60 rounded-2xl backdrop-blur-xl border border-sky-200/30 flex items-center justify-center shadow-lg shadow-sky-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '7.5s', animationDuration: '9s'}}>
                <MessageSquare className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              
              {/* Row 3 */}
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-blue-400/40 via-blue-500/50 to-blue-700/60 rounded-2xl backdrop-blur-xl border border-blue-200/30 flex items-center justify-center shadow-lg shadow-blue-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '8s', animationDuration: '9.2s'}}>
                <Calendar className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              ...
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-purple-400/40 via-purple-500/50 to-purple-700/60 rounded-2xl backdrop-blur-xl border border-purple-200/30 flex items-center justify-center shadow-lg shadow-purple-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '9s', animationDuration: '9.6s'}}>
                <Zap className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-orange-400/40 via-orange-500/50 to-orange-700/60 rounded-2xl backdrop-blur-xl border border-orange-200/30 flex items-center justify-center shadow-lg shadow-orange-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '9.5s', animationDuration: '9.8s'}}>
                <Building2 className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-cyan-400/40 via-cyan-500/50 to-cyan-700/60 rounded-2xl backdrop-blur-xl border border-cyan-200/30 flex items-center justify-center shadow-lg shadow-cyan-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '10s', animationDuration: '10s'}}>
                <Clock className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-red-400/40 via-red-500/50 to-red-700/60 rounded-2xl backdrop-blur-xl border border-red-200/30 flex items-center justify-center shadow-lg shadow-red-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '10.5s', animationDuration: '10.2s'}}>
                <Users className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-yellow-400/40 via-yellow-500/50 to-yellow-700/60 rounded-2xl backdrop-blur-xl border border-yellow-200/30 flex items-center justify-center shadow-lg shadow-yellow-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '11s', animationDuration: '10.4s'}}>
                <FileText className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-pink-400/40 via-pink-500/50 to-pink-700/60 rounded-2xl backdrop-blur-xl border border-pink-200/30 flex items-center justify-center shadow-lg shadow-pink-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '11.5s', animationDuration: '10.6s'}}>
                <MessageSquare className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              
              {/* Row 4 */}
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-indigo-400/40 via-indigo-500/50 to-indigo-700/60 rounded-2xl backdrop-blur-xl border border-indigo-200/30 flex items-center justify-center shadow-lg shadow-indigo-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '12s', animationDuration: '10.8s'}}>
                <Shield className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-teal-400/40 via-teal-500/50 to-teal-700/60 rounded-2xl backdrop-blur-xl border border-teal-200/30 flex items-center justify-center shadow-lg shadow-teal-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '12.5s', animationDuration: '11s'}}>
                <Globe className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-rose-400/40 via-rose-500/50 to-rose-700/60 rounded-2xl backdrop-blur-xl border border-rose-200/30 flex items-center justify-center shadow-lg shadow-rose-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '13s', animationDuration: '11.2s'}}>
                <CheckCircle className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-emerald-400/40 via-emerald-500/50 to-emerald-700/60 rounded-2xl backdrop-blur-xl border border-emerald-200/30 flex items-center justify-center shadow-lg shadow-emerald-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '13.5s', animationDuration: '11.4s'}}>
                <Star className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-violet-400/40 via-violet-500/50 to-violet-700/60 rounded-2xl backdrop-blur-xl border border-violet-200/30 flex items-center justify-center shadow-lg shadow-violet-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '14s', animationDuration: '11.6s'}}>
                <Smartphone className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              ...
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-lime-400/40 via-lime-500/50 to-lime-700/60 rounded-2xl backdrop-blur-xl border border-lime-200/30 flex items-center justify-center shadow-lg shadow-lime-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '15s', animationDuration: '12s'}}>
                <Zap className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
              <div className="w-24 h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-sky-400/40 via-sky-500/50 to-sky-700/60 rounded-2xl backdrop-blur-xl border border-sky-200/30 flex items-center justify-center shadow-lg shadow-sky-500/20 transform hover:scale-105 transition-all duration-800 animate-pulse relative overflow-hidden" style={{animationDelay: '15.5s', animationDuration: '12.2s'}}>
                <Building2 className="w-12 h-12 xl:w-14 xl:h-14 text-white/90 drop-shadow-lg relative z-10" />
              </div>
            </div>
            </div>
          ...
          <div className="absolute inset-0" style={{
            background: 'radial-gradient(circle at center, rgba(0,0,0,0.6) 20%, rgba(0,0,0,0.3) 60%, rgba(0,0,0,0.1) 90%)'
          }}></div>
        </div>
