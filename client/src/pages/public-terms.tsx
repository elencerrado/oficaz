      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <ul className="list-disc ml-6 mb-4 space-y-1">
            <li><strong>"Oficaz", "nosotros", "nos":</strong> Se refiere a José Ángel García Márquez (autónomo), responsable de la plataforma</li>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Oficaz - José Ángel García Márquez (Autónomo)</h3>
            <p className="mb-2">DNI: 09055639X</p>
            <p className="mb-2">Dirección: Avd. Clara Campoamor 4, Blq. 7 5º4, 21920 San Juan de Aznalfarache (Sevilla), España</p>
            <p className="mb-2">Email: <strong>soy@oficaz.es</strong></p>
            <p className="mb-2">Teléfono: +34 614 028 600</p>
            <p>Web: www.oficaz.es</p>
          </div>
