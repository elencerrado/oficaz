      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8">
            ...
            <p className="mb-2"><strong>José Ángel García Márquez (Autónomo)</strong></p>
            <p className="mb-2">DNI: 09055639X</p>
            <p className="mb-2">Dirección: Avd. Clara Campoamor 4, Blq. 7 5º4, 21920 San Juan de Aznalfarache (Sevilla)</p>
            <p className="mb-2">Email: soy@oficaz.es</p>
            <p>Teléfono: +34 614 028 600</p>
          </div>

          <div className="bg-blue-50 rounded-lg p-6 mb-8">
            <h3 className="text-lg font-semibold text-blue-900 mb-3">Delegado de Protección de Datos (DPO)</h3>
            <p className="mb-2">José Ángel García Márquez (acumula funciones)</p>
            <p className="mb-2">Email: soy@oficaz.es</p>
            <p>Puedes contactar directamente para cualquier consulta sobre protección de datos.</p>
          </div>
