                ...
                >
                  ...
                  {hasSpecialEvent && rangePosition !== 'none' && (
                    <>
                      ...
                      {rangePosition === 'middle' && (
                        <>
                          <div className={`absolute top-0.5 left-0 right-0 h-0.5 z-20 ${
                            eventColor === 'red-500' ? 'bg-red-500' :
                            eventColor === 'orange-500' ? 'bg-orange-500' :
                            eventColor === 'green-500' ? 'bg-green-500' : 'bg-yellow-500'
                          }`}></div>
                          <div className={`absolute bottom-0.5 left-0 right-0 h-0.5 z-20 ${
                            eventColor === 'red-500' ? 'bg-red-500' :
                            eventColor === 'orange-500' ? 'bg-orange-500' :
                            eventColor === 'green-500' ? 'bg-green-500' : 'bg-yellow-500'
                          }`}></div>
                      ...
                      {rangePosition === 'first' && (
                        <>
                          <div className={`absolute top-0.5 left-1/2 right-0 h-0.5 z-20 ${
                            eventColor === 'red-500' ? 'bg-red-500' :
                            eventColor === 'orange-500' ? 'bg-orange-500' :
                            eventColor === 'green-500' ? 'bg-green-500' : 'bg-yellow-500'
                          }`}></div>
                          <div className={`absolute bottom-0.5 left-1/2 right-0 h-0.5 z-20 ${
                            eventColor === 'red-500' ? 'bg-red-500' :
                            eventColor === 'orange-500' ? 'bg-orange-500' :
                            eventColor === 'green-500' ? 'bg-green-500' : 'bg-yellow-500'
                          }`}></div>
                          <div className={`absolute inset-0.5 rounded-l-full border-l-2 border-t-2 border-b-2 pointer-events-none z-20 ${
                            eventColor === 'red-500' ? 'border-red-500' :
                            eventColor === 'orange-500' ? 'border-orange-500' :
                            eventColor === 'green-500' ? 'border-green-500' : 'border-yellow-500'
                          }`}></div>
                      ...
                      {rangePosition === 'last' && (
                        <>
                          <div className={`absolute top-0.5 left-0 right-1/2 h-0.5 z-20 ${
                            eventColor === 'red-500' ? 'bg-red-500' :
                            eventColor === 'orange-500' ? 'bg-orange-500' :
                            eventColor === 'green-500' ? 'bg-green-500' : 'bg-yellow-500'
                          }`}></div>
                          <div className={`absolute bottom-0.5 left-0 right-1/2 h-0.5 z-20 ${
                            eventColor === 'red-500' ? 'bg-red-500' :
                            eventColor === 'orange-500' ? 'bg-orange-500' :
                            eventColor === 'green-500' ? 'bg-green-500' : 'bg-yellow-500'
                          }`}></div>
                          <div className={`absolute inset-0.5 rounded-r-full border-r-2 border-t-2 border-b-2 pointer-events-none z-20 ${
                            eventColor === 'red-500' ? 'border-red-500' :
                            eventColor === 'orange-500' ? 'border-orange-500' :
                            eventColor === 'green-500' ? 'border-green-500' : 'border-yellow-500'
                          }`}></div>
