        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="background: #007AFF; padding: ${content.subtitle ? '30px 20px 20px' : '30px 20px'}; text-align: center;">
              <img src="${window.location.origin}/email-logo-white.png" alt="Oficaz Logo" width="150" height="40" style="display: block; margin: 0 auto ${content.subtitle ? '15px' : '0'} auto;" />
              <!-- Subtitle -->
