        ...
        <div className="py-6 px-5">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4">
            <div className="flex items-center justify-center mb-1">
              ...
              <span className="font-semibold text-green-800 text-sm">14 días de prueba gratuitos</span>
            </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-5">
            <h3 className="font-semibold text-gray-900 text-center mb-3 text-sm">
              Hemos preparado datos de demostración
            </h3>
            
            <div className="grid grid-cols-2 gap-2 text-xs mb-3">
              <div className="flex items-center space-x-2">
                <Users className="h-3.5 w-3.5 text-oficaz-primary flex-shrink-0" />
                <span className="text-gray-700">4 empleados demo</span>
              </div>
              <div className="flex items-center space-x-2">
                <Calendar className="h-3.5 w-3.5 text-oficaz-primary flex-shrink-0" />
                <span className="text-gray-700">Fichajes de ejemplo</span>
              </div>
              <div className="flex items-center space-x-2">
                <MessageSquare className="h-3.5 w-3.5 text-oficaz-primary flex-shrink-0" />
                <span className="text-gray-700">Mensajes internos</span>
              </div>
              <div className="flex items-center space-x-2">
                <FileText className="h-3.5 w-3.5 text-oficaz-primary flex-shrink-0" />
          ...
          <div className="flex justify-center">
            <Button 
              onClick={onClose}
              className="px-6 py-2.5 bg-oficaz-primary hover:bg-blue-600 text-white rounded-lg font-medium shadow-md transition-all duration-200 hover:shadow-lg"
            >
              Comenzar
            </Button>
          </div>
