...
export function StripePaymentForm({ planName, planPrice, onSuccess, onCancel }: StripePaymentFormProps) {
  ...
  return (
    <Card className="max-w-md mx-auto !bg-white !text-gray-900 !border-gray-200 [&_*]:!bg-white [&_*]:!text-gray-900 [&_button]:!bg-white [&_button]:!text-gray-900 [&_button]:!border-gray-300 [&_button]:!rounded-lg [&_input]:!bg-white [&_input]:!text-gray-900 [&_input]:!border-gray-300 [&_input]:!rounded-lg [&_label]:!text-gray-900 [&_p]:!text-gray-600 [&_h3]:!text-gray-900 [&_.stripe-payment-element_*]:!bg-white [&_.stripe-payment-element_*]:!text-gray-900" style={{ borderRadius: '0.5rem !important' }}>
