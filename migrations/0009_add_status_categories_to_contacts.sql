-- Add status categories to business_contacts
...
-- cuando se haga la primera petición a /api/crm/status-categories
...
CREATE INDEX IF NOT EXISTS idx_business_contacts_status_categories 
ON business_contacts USING GIN (status_categories);

COMMENT ON COLUMN business_contacts.status_categories IS 'IDs de categorías de estado del CRM';
