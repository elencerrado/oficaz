...
export const ADDON_DEFINITIONS: AddonDefinition[] = [
  ...
  {
    key: 'crm',
    name: 'CRM: Clientes y Proyectos',
    description: 'Gestiona todos tus clientes, proveedores y proyectos en un solo lugar. Vincula contactos a proyectos, track automático de relaciones comerciales. La central de tu negocio.',
    shortDescription: 'Tus clientes y proyectos organizados',
    isFreeFeature: false,
    monthlyPrice: 8,
    icon: 'Users2',
  },
  {
    ...
    description: 'Sistema contable básico integrado. Registra ingresos y gastos, categoriza movimientos automáticamente, y genera informes financieros simples. Todo lo esencial para el control económico.',
    shortDescription: 'Gestión contable simplificada',
    isFreeFeature: false,
    monthlyPrice: 10,
    icon: 'Calculator',
  },
  {
    key: 'inventory',
    name: 'Inventario',
    description: 'Control completo de stock y materiales. Registra entradas y salidas, alertas de stock mínimo, seguimiento de ubicaciones. Ideal para almacenes y tiendas.',
    shortDescription: 'Control de stock y materiales',
    isFreeFeature: false,
    monthlyPrice: 8,
    icon: 'Package',
  },
