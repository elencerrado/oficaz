...
# Opcional: configurar modelos de OpenAI para la IA integrada (por defecto rápido: `gpt-4o-mini`, potente: `gpt-4o`)
# AI_INTEGRATIONS_OPENAI_API_KEY=""
# AI_INTEGRATIONS_OPENAI_FAST_MODEL="gpt-4o-mini"
# AI_INTEGRATIONS_OPENAI_STRONG_MODEL="gpt-4o"
```
...
**Para crear migraciones nuevas**, consulta [DATABASE_MIGRATIONS.md](./DATABASE_MIGRATIONS.md) - guía completa del patrón oficial.
